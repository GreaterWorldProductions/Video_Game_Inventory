...
import { DataTable, GameForm } from '../../components';
      ...
      <Box sx={{display:'flex'}} >
        ...
        >
          <Toolbar sx={myStyles.toolbar}>
            ...
            <Typography variant="h6" noWrap>This Is Where Games Are Made</Typography>          
            <Button sx={ myStyles.toolbar_button } onClick={handleDialogOpen}>Add Video Game</Button>
            <Dialog open={dialogOpen} onClose={handleDialogClose} aria-labeledby='form-dialog-title'>
                <DialogTitle id = 'form-dialog-title'>Add New Game</DialogTitle>
                    <DialogContent>
                        <DialogContentText>Your Game is on it's way!</DialogContentText>
                            <GameForm />
                    </DialogContent>
                <DialogActions>
